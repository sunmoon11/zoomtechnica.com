...
function cherry_register_sidebars() {
	...
	cherry_register_sidebar(
  	...
  	cherry_register_sidebar(
		array(
			'id'          => 'sidebar-2-footer-1',
			'name'        => __( 'Footer 2 Sidebar 1', 'cherry' ),
			'description' => __( 'A sidebar located in the footer of the site.', 'cherry' ),
		)
	);
  	cherry_register_sidebar(
		array(
			'id'          => 'sidebar-2-footer-2',
			'name'        => __( 'Footer 2 Sidebar 2', 'cherry' ),
			'description' => __( 'A sidebar located in the footer of the site.', 'cherry' ),
		)
	);
  	cherry_register_sidebar(
		array(
			'id'          => 'sidebar-2-footer-3',
			'name'        => __( 'Footer 2 Sidebar 3', 'cherry' ),
			'description' => __( 'A sidebar located in the footer of the site.', 'cherry' ),
		)
	);
