...
function motopressCEGoogleFontsFields() {
    ...
    if (!isset($error['error'])) {
        ...
        foreach ($googleFontClasses as $className => $googleFontClass) {
            ...
            echo '<button class="mp-remove-google-font-class-entry button">' . $motopressCELang->CEOptGoogleFontsRemoveClass . '</button>';
            echo '</div>';
        ...
        echo '<button class="mp-create-google-font-class-entry button">' . $motopressCELang->CEOptGoogleFontsCreateClass . '</button>';
