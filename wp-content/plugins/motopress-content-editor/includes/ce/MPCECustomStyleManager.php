...
//		add_action('wp_footer', array($this, 'printStyles'), 21);
	...
	public static function stylesMetaBoxSave($postId) {
		...
		if (defined('DOING_AUTOSAVE') && DOING_AUTOSAVE) return false; // Don't save on auto save
		if (!isset($_POST[self::WP_META_BOX_STYLES_NONCE]) || !wp_verify_nonce($_POST[self::WP_META_BOX_STYLES_NONCE], self::WP_META_BOX_STYLES_NONCE)) return false;
