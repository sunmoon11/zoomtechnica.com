...
">"+this.tagClass,this.proxy("onTagClick"))},initStyle:function(){this.$style=c('<style type="text/css" id="mpce-wp-more-style" />');this.$body.append(this.$style)},onPointClick:function(a,b){b=c(a.target);switch(this.getPositionType(b)){case "first":this.$moreTag.prependTo(this.$contentWrapper);break;case "last":this.$contentWrapper.find(">.motopress-row:last").after(this.$moreTag);break;default:b.parent().before(this.$moreTag)}CE.Utils.addSceneState(this.selectedState)},onTagClick:function(){CE.Utils.removeSceneState(this.selectedState);
...
objectDot:c("<div />",{"class":"motopress-ce-object-dot motopress-default"}),objectIcon:c("<div />",{"class":"motopress-ce-object-icon"}),objectName:c("<span />",{"class":"motopress-ce-object-name motopress-default motopress-no-color-text"}),library:null,visibility:!1,$html:null,bodyEl:null,active:!1,setup:function(){this.groupIcon.append(this.groupActive).appendTo(this.groupInner);this.groupInner.append(this.groupPopover).appendTo(this.group);this.objectInner.append(this.objectDot,this.objectIcon,
this.objectName).appendTo(this.object);this.$html=c("html");this.bodyEl=c("body");this.leftBar.append(this.widgetsWrapper,this.customWrapper);this.bodyEl.prepend(this.leftBar).append(this.leftBarOverlap)},init:function(){CE.LeftBar.myThis=this;this.leftBar.hasClass("mpce-leftbar-hidden")||(this.setActive(),this.setVisible(),parent.CE.Navbar.myThis.setWidgetBtnActive());this.initLibrary();this.initCustom();this.hoverActive();this.initStyle();new CE.DragDrop;var a=c("#motopress-templates");a.length&&
new CE.Template(a);this.addMetaInputs();parent.MP.Preloader.myThis.load(CE.LeftBar.shortName)},initStyle:function(){var a=parseFloat(this.$html.css("padding-left"))+this.width;this.$style=c('<style type="text/css" id="mpce-left-bar-style" />');this.$style.text("html.mpce-page-offset { padding-left: "+a+"px !important; }");this.bodyEl.append(this.$style)},initCustom:function(){var a=this,b,d,e={};b='<div class="mpce-leftbar-custom-group-1"><div class="motopress-leftbar-group motopress-default mpce-leftbar-more-btn" title="'+
localStorage.getItem("CELeftBarWPMoreTitle")+'"><div class="motopress-leftbar-group-inner motopress-default"><div class="motopress-leftbar-group-icon mpce-leftbar-more-icon"><div class="motopress-leftbar-group-active motopress-default"></div></div></div></div>';parent.motopressCE.settings.wp.white_label_active||(b+='<div class="motopress-leftbar-group motopress-default mpce-leftbar-addons-btn" title="'+localStorage.getItem("CELeftBarAddonsTitle")+'"><div class="motopress-leftbar-group-inner motopress-default"><div class="motopress-leftbar-group-icon mpce-leftbar-addons-icon"><a href="'+
parent.motopressCE.settings.wp.home_addons_url+'" target="_blank" class="motopress-leftbar-group-active motopress-default"></a></div></div></div>');d=c(b+"</div>");c.each(["more","addons"],function(a,b){e[b]=d.find(".mpce-leftbar-"+b+"-btn")});d.find(".motopress-leftbar-group").on("mouseover",function(b){a.customGrpOnMouseover(b,this)}).on("mouseout",function(b){a.customGrpOnMouseout(b,this)});e.more.find(".motopress-leftbar-group-active").on("mousedown",function(b){a.customActiveGrpOnMousedown(b,
this)});d.appendTo(this.customWrapper)},addMetaInputs:function(){c("form#post #motopress-ce-edited-post",parent.document).length||c("form#post",parent.document).prepend(c("<input>",{type:"hidden",id:"motopress-ce-edited-post",name:"motopress-ce-edited-post",value:parent.motopressCE.postID}))},initLibrary:function(){var a=parent.motopressCE.settings.library;CE.LeftBar.myThis.library=c.extend(!0,{},a.groups);this.initLibraryStyles();c.isPlainObject(a.globalPredefinedClasses)&&!c.isEmptyObject(a.globalPredefinedClasses)&&
(CE.Style.globalPredefinedClasses=a.globalPredefinedClasses);c.isArray(a.tinyMCEStyleFormats)&&!c.isEmptyObject(a.tinyMCEStyleFormats)&&(CE.InlineEditor.styleFormats=a.tinyMCEStyleFormats);c.isPlainObject(a.templates)&&!c.isEmptyObject(a.templates)&&(CE.Template.templates=a.templates);CE.LeftBar.myThis.createGroup()},initLibraryStyles:function(){var a;c.each(parent.motopressCE.settings.library.groups,function(b,d){d.hasOwnProperty("objects")&&c.each(d.objects,function(d,f){CE.LeftBar.myThis.library[b].objects[d].styles=
c.extend(!0,{},CE.Style.props,CE.LeftBar.myThis.library[b].objects[d].styles);CE.Shortcode.isGrid(b)?(CE.LeftBar.myThis.library[b].objects[d].styles.margin.sides.splice(2),CE.LeftBar.myThis.library[b].objects[d].styles.margin["default"].splice(2)):CE.LeftBar.myThis.library[b].objects[d].styles.margin.regExp=new RegExp("^"+CE.LeftBar.myThis.library[b].objects[d].styles.margin.classPrefix+"(?:|("+CE.LeftBar.myThis.library[b].objects[d].styles.margin.sides.join("|")+")-)("+CE.LeftBar.myThis.library[b].objects[d].styles.margin.values.slice(1).join("|")+
")$","i");f.styles.hasOwnProperty("mp_custom_style")&&f.styles.mp_custom_style.hasOwnProperty("limitation")&&(a=f.styles.mp_custom_style.limitation,c.each(a,function(a,c){CE.LeftBar.myThis.library[b].objects[d].styles.mp_custom_style.parameters.hasOwnProperty(c)&&delete CE.LeftBar.myThis.library[b].objects[d].styles.mp_custom_style.parameters[c]}))})})},createGroup:function(){if(null!==this.library&&!c.isEmptyObject(this.library)){var a=this,b,d,e;for(e in this.library)this.library[e].show&&(b=this.group.clone(),
d=b.find(".motopress-leftbar-group-icon"),d.css("background-image","url("+this.library[e].icon+")"),b.clickover({html:!0,animation:!1,width:this.getPopupWidth(this.library[e]),title:localStorage.getItem("addBlockTip"),content:this.createObject(this.library[e].id,this.library[e].objects),onShown:function(){a.popoverOnShown(this)},onHidden:function(){a.popoverOnHidden(this)}}),b.find(".motopress-leftbar-group-active").on("mousedown",this.proxy("activeGrpOnMousedown")),b.appendTo(this.widgetsWrapper))}},
popoverOnShown:function(a){a.$tip.find(".arrow").removeClass("arrow").addClass("motopress-ce-arrow");var b=a.$element.is(":first-child")?5:0,b=parseInt(a.$tip.css("top"))+parseInt(a.$tip.css("height"))/2-23+b;a.$tip.css("top",b);a=a.$tip.find(".popover-title");a.addClass("motopress-default motopress-default-text");a.next(".popover-content").length&&(b=a.next(),a.insertAfter(b),b.addClass("motopress-ce-object-container"));CE.DragDrop.myThis.makeDraggableNewBlock()},popoverOnHidden:function(a){a.$element.find(".motopress-leftbar-group-active").removeClass("active")},
activeGrpOnMousedown:function(a){a.preventDefault();a.stopPropagation()},activeGrpOnMouseover:function(){c(this).addClass("active")},customGrpOnMouseover:function(a,b){this.hideActiveWidgetsGroup()},customGrpOnMouseout:function(a,b){c(b).find(".motopress-leftbar-group-active").removeClass("active")},customActiveGrpOnMousedown:function(a,b){c(b).hasClass("selected")?(c(b).removeClass("selected"),CE.Utils.removeSceneAction("edit-more")):(c(b).addClass("selected"),CE.Utils.addSceneAction("edit-more"))},
getPopupWidth:function(a){return 6>Object.keys(a.objects).length?"205px":"620px"},createObject:function(a,b){if(!c.isEmptyObject(b)){var d=c("<div />"),e,f,g;for(g in b)b[g].show&&(e=this.object.clone(),this.setAttrs(e,a,b[g]),f=e.find(".motopress-ce-object-icon"),f.css("background-image","url("+b[g].icon+")"),f=e.find(".motopress-ce-object-name"),f.text(b[g].name),d.append(e));return d}},setAttrs:function(a,b,d){a.attr({"data-motopress-close-type":d.closeType,"data-motopress-shortcode":d.id,"data-motopress-group":b,
"data-motopress-resize":d.resize});var e=d.parameters,f;c.isEmptyObject(e)||(f={},c.each(e,function(a){f[a]={}}),a.attr("data-motopress-parameters",JSON.stringify(f)));b=this.getStyleAttrs(b,d.id);c.extend(!0,b,d.styles,b);if(!c.isEmptyObject(b)){var g={};c.each(b,function(a){g[a]={}});a.attr("data-motopress-styles",JSON.stringify(g))}},hoverActive:function(){c(".motopress-leftbar-group .motopress-leftbar-group-active").mouseover(this.activeGrpOnMouseover)},disable:function(){this.hideActiveWidgetsGroup();
this.leftBarOverlap.show()},enable:function(){this.leftBarOverlap.hide()},setActive:function(){this.active=!0},setInactive:function(){this.active=!1},isActive:function(){return this.active},setVisible:function(){this.visibility=!0},setInvisible:function(){this.visibility=!1},isVisible:function(){return this.visibility},hide:function(a){if(("undefined"===typeof a?0:a)||this.isActive())this.setInvisible(),this.hideActiveWidgetsGroup(),this.leftBar.addClass("mpce-leftbar-hidden"),this.leftBarOverlap.addClass("mpce-leftbar-overlap-hidden"),
this.$html.removeClass("mpce-page-offset"),parent.CE.Iframe.myThis.setSceneWidth(),CE.Resizer.myThis.updateAllHandles(),parent.MP.Editor.triggerEverywhere("LeftBarHide")},show:function(a){if(("undefined"===typeof a?0:a)||this.isActive())this.setVisible(),this.leftBar.removeClass("mpce-leftbar-hidden"),this.leftBarOverlap.removeClass("mpce-leftbar-overlap-hidden"),this.$html.addClass("mpce-page-offset"),parent.CE.Iframe.myThis.setSceneWidth(),CE.Resizer.myThis.updateAllHandles(),parent.MP.Editor.triggerEverywhere("LeftBarShow")},
hideActiveWidgetsGroup:function(){this.leftBar.find('.motopress-leftbar-group[data-clickover-open="1"]').trigger("mousedown")},getSpace:function(){return this.isVisible()?this.width:0},getWidth:function(){return this.width},getStyleAttrs:function(a,b){return c.extend(!0,{},this.library[a].objects[b].styles)},getPrivateStyleAttrs:function(a,b){return this.getStyleAttrs(a,b).mp_custom_style.parameters},getParametersAttrs:function(a,b){return c.extend(!0,{},this.library[a].objects[b].parameters)},getShortcodeLabel:function(a,
b){return this.library[a].objects[b].name}})}(jQuery),function(c){CE.ShortcodeStyle=can.Construct({generateStateCSS:function(a){var b=[];c.each(a,function(a,c){if(""!==c)switch(a){case "padding-top":case "padding-bottom":case "padding-left":case "padding-right":case "margin-top":case "margin-bottom":case "margin-left":case "margin-right":case "border-top-width":case "border-bottom-width":case "border-left-width":case "border-right-width":case "border-top-left-radius":case "border-top-right-radius":case "border-bottom-left-radius":case "border-bottom-right-radius":isNaN(c)||
...
c+" !important;"));break;case "background-position":"custom"!==c&&b.push(CE.ShortcodeStyle.generateStyleRule(a,c+" !important;"));break;case "border-radius":b.push(CE.ShortcodeStyle.generateStyleRule("-webkit-"+a,c+" !important;"));b.push(CE.ShortcodeStyle.generateStyleRule("-moz-"+a,c+" !important;"));b.push(CE.ShortcodeStyle.generateStyleRule(a,c+" !important;"));break;default:b.push(CE.ShortcodeStyle.generateStyleRule(a,c+" !important;"))}});return b},generateCSS:function(a,b,d){void 0===typeof d&&
(d=!1);null===a&&(a="%className%");var e="";b.hasOwnProperty("up")&&c.each(CE.ShortcodeStyle.generateStateCSS(b.up),function(b,c){e+="."+a+c;d&&(e+="."+a+"."+CE.ShortcodeStyle.previewStateClassPrefix+"up"+c)});b.hasOwnProperty("hover")&&c.each(CE.ShortcodeStyle.generateStateCSS(b.hover),function(b,c){e=d?e+("."+a+"."+CE.ShortcodeStyle.previewStateClassPrefix+"hover"+c):e+("."+a+":hover"+c)});b.hasOwnProperty("tablet")&&c.each(CE.ShortcodeStyle.generateStateCSS(b.tablet),function(b,c){e=d?e+("."+a+
"."+CE.ShortcodeStyle.previewStateClassPrefix+"tablet"+c):e+("@media (max-width: 768px) { ."+a+c+"}")});b.hasOwnProperty("mobile")&&c.each(CE.ShortcodeStyle.generateStateCSS(b.mobile),function(b,c){e=d?e+("."+a+"."+CE.ShortcodeStyle.previewStateClassPrefix+"mobile"+c):e+("@media (max-width: 320px) { ."+a+c+"}")});return e},generateStyleRule:function(a,b){var d=":not(."+parent.motopressCE.styleEditor["const"].prefixRuleDisable+a+"){";c.isArray(b)||(b=[b]);c.each(b,function(){d+=a+":"+this});return d+=
"}"},previewStateClassPrefix:"motopress-ce-preview-state-"},{settings:null,css:null,emulateCSS:null,className:null,updateMetaField:function(){},init:function(a,b,d){this.className=a;this.settings="undefined"!==typeof b?b:{};"undefined"!==typeof d?(this.css=d,this.emulateCSS=CE.ShortcodeStyle.generateCSS(this.className,this.settings,!0)):this.regenerateCSS();this.detectStyleTag();this.updateStyleTag()},getClassName:function(){return this.className},getCSS:function(){return this.css},getEmulateCSS:function(){return this.emulateCSS},
getSettings:function(){return c.extend({},this.settings)},getStateSettings:function(a){return this.settings.hasOwnProperty(a)?c.extend({},this.settings[a]):{}},isEmpty:function(){var a=!0;c.each(this.settings,function(b,d){c.each(d,function(b,d){""!==d&&(a=!1)})});return a},regenerateCSS:function(){this.css=CE.ShortcodeStyle.generateCSS(this.className,this.settings,!1);this.emulateCSS=CE.ShortcodeStyle.generateCSS(this.className,this.settings,!0)},update:function(a){this.settings=a;this.regenerateCSS();
this.updateStyleTag();this.updateMetaField()},updateState:function(a,b){this.settings[a]=b;this.regenerateCSS();this.updateStyleTag();this.updateMetaField()},"delete":function(){this.styleTag.remove();this.updateMetaField()},updateStyleTag:function(){var a=CE.StyleEditor.myThis.isEmulateCSSMode()?this.getEmulateCSS():this.getCSS();this.styleTag.text(a)},detectStyleTag:function(){var a=this.stylesWrapper.children("#"+this.className);a.length||(a=this.generateStyleTag());this.styleTag=a},generateStyleTag:function(){var a=
c("<style />",{id:this.getClassName(),text:this.getCSS()});this.stylesWrapper.append(a);return a}})}(jQuery),function(c){CE.ShortcodeStyle("CE.ShortcodePrivateStyle",{stylesWrapper:c("#motopress-ce-private-styles-wrapper"),addRenderedStyleTags:function(a){a.filter(function(a,d){return 0===CE.ShortcodePrivateStyle.stylesWrapper.children("#"+c(d).attr("id")).length});CE.ShortcodePrivateStyle.stylesWrapper.append(a)}},{styleTag:null,stylesWrapper:null,init:function(a,b,d){this.stylesWrapper=CE.ShortcodePrivateStyle.stylesWrapper;
this._super(a,b,d)},updateMetaField:function(){CE.StyleEditor.myThis.udpatePrivateStylesMeta()},clear:function(){this.update({});CE.StyleEditor.myThis.udpatePrivateStylesMeta()}})}(jQuery),function(c){CE.ShortcodeStyle("CE.ShortcodePresetStyle",{stylesWrapper:c("#motopress-ce-preset-styles-wrapper")},{styleTag:null,label:"",stylesWrapper:null,init:function(a,b,d,c){this.stylesWrapper=CE.ShortcodePresetStyle.stylesWrapper;this._super(a,b,d);this.setLabel(c)},getLabel:function(){return this.label},
setLabel:function(a){this.label=a},updateLabel:function(a){this.label=a;CE.StyleEditor.myThis.updatePresetStylesMeta()},updateMetaField:function(){CE.StyleEditor.myThis.updatePresetStylesMeta()}})}(jQuery),function(c){CE.StyleEditor=can.Construct({myThis:null},{presets:{},presetsMetaField:null,presetsLastIdMetaField:null,privateStyles:{},presetStyles:{},presetsLastId:null,presetDefaultLabel:null,privateMetaField:null,prefixPresetClass:null,prefixPrivateClass:null,privateStylesWrapper:null,presetStylesWrapper:null,
presetSaveModal:null,emulateCSSMode:!0,init:function(){CE.StyleEditor.myThis=this;this.presetSaveModal=parent.CE.PresetSaveModal.myThis;this.initPrivateStyles();this.initPresetStyles();this.initEvents()},initPresetStyles:function(){var a=this;this.prefixPresetClass=parent.motopressCE.styleEditor["const"].prefixPresetClass;this.presetsLastIdMetaField=parent.CE.Navbar.myThis.presetsLastIdMetaField;this.presetsMetaField=parent.CE.Navbar.myThis.presetsMetaField;this.presetsLastId=parent.motopressCE.styleEditor.presets_last_id;
this.presetDefaultLabel=parent.motopressCE.styleEditor["const"].presetDefaultLabel;c.each(parent.motopressCE.styleEditor.presets,function(b,d){a.presetStyles[b]=new CE.ShortcodePresetStyle(b,d.settings,d.css,d.label)})},initEvents:function(){parent.MP.Editor.onIfr("AfterUpdate",this.proxy("clearPresetsField"))},getPresetsLastId:function(){return this.presetsLastId},incPresetsLastId:function(){this.presetsLastId++;return this.presetsLastId},initPrivateStyles:function(){var a=this;this.prefixPrivateClass=
parent.motopressCE.styleEditor["const"].prefixPrivateClass;this.privateMetaField=parent.CE.Navbar.myThis.privatesMetaField;c.each(this.getPrivateStylesMeta(),function(b,d){a.privateStyles[b]=new CE.ShortcodePrivateStyle(b,d.settings)})},udpatePrivateStylesMeta:function(){this.privateMetaField.val(this.getPrivateStylesString());parent.CE.Save.changeContent()},getPrivateStylesMeta:function(){return c.parseJSON(this.privateMetaField.val())},getPrivateStylesString:function(){var a={};c.each(this.privateStyles,
function(b,d){d.isEmpty()||(a[b]={settings:d.getSettings(),css:d.getCSS()})});return JSON.stringify(a)},getPrivateStyleInstance:function(a){a=this.retrievePrivateClass(a);if(""!==a&&this.privateStyles.hasOwnProperty(a))return this.privateStyles[a];a=this.generatePrivateClass();return this.createPrivateStyle(a)},getPresetStyleInstance:function(a){a=this.retrievePresetClass(a);return this.isExistsPreset(a)?this.presetStyles[a]:null},createPrivateStyle:function(a,b){this.privateStyles[a]=new CE.ShortcodePrivateStyle(a,
b);return this.privateStyles[a]},retrievePrivateClass:function(a){a=(new RegExp("(?:^|\\s)+("+this.prefixPrivateClass+"[\\d]+-[\\S]+)(?:$|\\s)+")).exec(a);return null!==a&&2===a.length?a[1]:""},generatePrivateClass:function(){var a=parent.MP.Utils.uniqid(this.prefixPrivateClass+parent.motopressCE.postID+"-");return this.privateStyles.hasOwnProperty(a)?this.generatePrivateClass():a},getPresetsString:function(){var a={};c.each(this.presetStyles,function(b,d){a[b]={settings:d.getSettings(),css:d.getCSS(),
label:d.getLabel()}});return JSON.stringify(a)},getPresetsList:function(a){var b={};c.each(this.presetStyles,function(a,c){b[c.getClassName()]=c.getLabel()});a&&(b=c.extend({"":localStorage.getItem("CENone")},b));return b},getPresetsListSelect2:function(){var a=[];c.each(this.presetStyles,function(b,d){a.push({id:d.getClassName(),text:d.getLabel()})});return a},generatePresetClassName:function(){return this.prefixPresetClass+this.incPresetsLastId()},createPreset:function(a,b){var d=this.generatePresetClassName();
""===a&&(a=this.presetDefaultLabel+this.getPresetsLastId());this.presetStyles[d]=new CE.ShortcodePresetStyle(d,b,void 0,a);this.updatePresetStylesMeta();return this.presetStyles[d]},deletePreset:function(a){this.isExistsPreset(a)&&(this.presetStyles[a]["delete"](),delete this.presetStyles[a],this.updatePresetStylesMeta());return!0},updatePresetStylesMeta:function(){parent.motopressCE.styleEditor.presets=this.presetStyles;this.presetsLastIdMetaField.val(this.getPresetsLastId());this.presetsMetaField.val(this.getPresetsString());
parent.CE.Save.changeContent()},clearPresetsField:function(){this.presetsLastIdMetaField.val("");this.presetsMetaField.val("")},isExistsPreset:function(a){return this.presetStyles.hasOwnProperty(a)},retrievePresetClass:function(a){a=(new RegExp("(?:^|\\s)+("+this.prefixPresetClass+"[\\d]+)(?:$|\\s)+")).exec(a);return null!==a&&2===a.length?a[1]:""},changePrivateClassToDuplicated:function(a){if(""!==a){var b=CE.StyleEditor.myThis.retrievePrivateClass(a);if(""!==b){var d=CE.StyleEditor.myThis.duplicatePrivateStyle(b);
a=a.replace(b,d.getClassName())}}return a},duplicatePrivateStyle:function(a){var b=this.generatePrivateClass();a=this.privateStyles.hasOwnProperty(a)?this.createPrivateStyle(b,this.privateStyles[a].getSettings()):this.createPrivateStyle(b);this.udpatePrivateStylesMeta();return a},setEmulateCSSMode:function(){this.emulateCSSMode=!0;c.each(this.presetStyles,function(){this.updateStyleTag()});c.each(this.privateStyles,function(){this.updateStyleTag()})},unsetEmulateCSSMode:function(){this.emulateCSSMode=
!1;c.each(this.presetStyles,function(){this.updateStyleTag()});c.each(this.privateStyles,function(){this.updateStyleTag()})},isEmulateCSSMode:function(){return this.emulateCSSMode}})}(jQuery),function(c){CE.ImageLibrary=can.Construct({myThis:null},{frame:null,propertyImage:null,init:function(){CE.ImageLibrary.myThis=this;this.frame=parent.wp.media({id:"motopress-image-library",multiple:!1,describe:!1,toolbar:"select",sidebar:"settings",content:"upload",router:"browse",menu:"default",searchable:!0,
filterable:!1,sortable:!1,title:localStorage.getItem("CEImageLibraryText"),button:{text:localStorage.getItem("CEImageLibraryText")},library:{type:"image"},contentUserSetting:!0,syncSelection:!0});this.frame.on("open",this.proxy("onOpen"));this.frame.on("select",this.proxy("setImage"));this.frame.on("close",this.proxy("onClose"))},onOpen:function(){this.frame.reset();this.propertyImage=CE.Dialog.myThis.element.find('[data-motopress-open-img-lib="1"]');var a=this.propertyImage.control();null!==a.id&&
(a=parent.wp.media.attachment(a.id),a.fetch(),this.frame.state().get("selection").add(a))},setImage:function(){var a=this.frame.state().get("selection").models[0].attributes,b="full";a.sizes.hasOwnProperty("medium")?b="medium":a.sizes.hasOwnProperty("thumbnail")&&(b="thumbnail");var b=a.sizes[b].url,d=this.propertyImage.control();d.set({id:a.id,src:b,full:a.sizes.full.url});d.showTools();d.element.trigger("change");this.propertyImage.removeAttr("data-motopress-open-img-lib")},onClose:function(){c("."+
CE.Dialog.myThis.dialogClass).focus();var a=c(parent.document).find("html, body");a.addClass("motopress-ce-jumping-fix");var b=setTimeout(function(){a.removeClass("motopress-ce-jumping-fix");clearTimeout(b)},0)}})}(jQuery),function(c){CE.Link=can.Construct({myThis:null,wpLink:null,submitCallback:null,closeCallback:null,inputs:{}},{init:function(){CE.Link.myThis=this;CE.Link.wpLink=parent.wpLink;CE.Link.inputs.submit=c("#wp-link-submit",parent.document);CE.Link.inputs.cancel=c("#wp-link-cancel",parent.document);
parent.MP.Utils.version_compare(parent.motopressCE.settings.wp.wordpress_version,"4.2",">=")?(CE.Link.inputs.url=c("#wp-link-url",parent.document),CE.Link.inputs.title=c("#wp-link-text",parent.document),CE.Link.inputs.openInNewTab=c("#wp-link-target",parent.document)):(CE.Link.inputs.url=c("#url-field",parent.document),CE.Link.inputs.title=c("#link-title-field",parent.document),CE.Link.inputs.openInNewTab=c("#link-target-checkbox",parent.document))},open:function(a,b,d,e){var f={url:!0,title:!0,target:!0};
"undefined"!==typeof b&&c.extend(f,b);if("undefined"!=typeof CE.Link.wpLink){CE.Link.submitCallback=d;CE.Link.inputs.submit.off("mousedown.motopress-wplink-submit").on("mousedown.motopress-wplink-submit",this.wpSubmitButtonHandler);CE.Link.inputs.cancel.off("click.motopress-wplink-cancel").on("click.motopress-wplink-cancel",e);parent.wpActiveEditor=parent.tinyMCE.activeEditor.id;var g=null;CE.Link.wpLink.setDefaultValues=function(){var b=null,d=null;c.isPlainObject(a)?(g=a.href,b="_blank"===a.target?
!0:!1,d=a.textarea):(g=a.val(),d=a);if(""===g||"#"===g)g="http://";CE.Link.inputs.url.val(g);CE.Link.inputs.openInNewTab.prop("checked",b);CE.Link.wpLink.textarea=d};CE.Link.wpLink.open();g||(g=c.isPlainObject(a)?a.href:a.val(),CE.Link.inputs.url.val(g));"undefined"===typeof CE.Link.inputs.close&&(CE.Link.inputs.close=c(".ui-dialog-titlebar-close",parent.document));CE.Link.inputs.close.off("mousedown.motopress-wplink-close").on("mousedown.motopress-wplink-close",e);f.url||CE.Link.inputs.url.closest("div").hide();
f.title||CE.Link.inputs.title.closest("div").hide();f.target||CE.Link.inputs.openInNewTab.closest("div").hide();parent.CE.Iframe.myThis.wpLinkCloseCallback(this.onDialogClose)}},wpCancelButtonHandler:function(a){CE.Link.wpLink.close();return!1},wpSubmitButtonHandler:function(a){a=CE.Link.wpLink.getAttrs();if(a.href&&"http://"!=a.href)return CE.Link.submitCallback&&CE.Link.submitCallback(a),CE.Link.wpLink.close(),!1},onDialogClose:function(){CE.Link.inputs.submit.off("mousedown.motopress-wplink-submit");
CE.Link.inputs.cancel.off("click.motopress-wplink-cancel");CE.Link.inputs.close.off("mousedown.motopress-wplink-close");CE.Link.inputs.url.closest("div").show();CE.Link.inputs.title.closest("div").show();CE.Link.inputs.openInNewTab.closest("div").show()}})}(jQuery),function(c){CE.WPGallery=can.Construct({myThis:null},{frame:null,ctrl:null,init:function(){CE.WPGallery.myThis=this;var a=parent.wp.media,b=a.model.Attachment;a.controller.CEGallery=a.controller.FeaturedImage.extend({defaults:parent._.defaults({id:"motopress-media-library-gallery",
title:localStorage.getItem("CEWpGalleryText"),toolbar:"main-insert",filterable:"uploaded",library:a.query({type:"image"}),multiple:"add",editable:!0,priority:60,syncSelection:!1},a.controller.Library.prototype.defaults),updateSelection:function(){var a=this.get("selection"),c=CE.WPGallery.myThis.ctrl.get(),f;""!==c&&-1!==c&&(f=parent._.map(c.split(/,/),function(a){return b.get(a)}));a.reset(f)}});a.view.MediaFrame.CEGallery=a.view.MediaFrame.Post.extend({createStates:function(){this.states.add([new a.controller.CEGallery])},
bindHandlers:function(){a.view.MediaFrame.Select.prototype.bindHandlers.apply(this,arguments);this.on("toolbar:create:main-insert",this.createToolbar,this);parent._.each({content:{embed:"embedContent","edit-selection":"editSelectionContent"},toolbar:{"main-insert":"mainInsertToolbar"}},function(a,b){parent._.each(a,function(a,d){this.on(b+":render:"+d,this[a],this)},this)},this)},mainInsertToolbar:function(a){var b=this;this.selectionStatusToolbar(a);a.set("insert",{style:"primary",priority:80,text:localStorage.getItem("CEWpGalleryText"),
requires:{selection:!0},click:function(){var a=b.state(),d=a.get("selection");b.close();a.trigger("insert",d).reset()}})}});this.frame=new a.view.MediaFrame.CEGallery(parent._.defaults({},{state:"motopress-media-library-gallery",title:localStorage.getItem("CEWpGalleryText"),library:{type:"image"},multiple:!0}));this.frame.on("open",this.proxy("onOpen"));this.frame.on("close",this.proxy("onClose"));this.frame.on("insert",this.proxy("setImage"))},open:function(a){this.ctrl=a;this.frame.open()},onOpen:function(){var a=
this.frame;a.reset();var b=this.ctrl.getArray();if(null!==b){var d=null;b.forEach(function(b){d=parent.wp.media.attachment(b);d.fetch();a.state().get("selection").add(d)})}},onClose:function(){c("."+CE.Dialog.myThis.dialogClass).focus();var a=c(parent.document).find("html, body");a.addClass("motopress-ce-jumping-fix");var b=setTimeout(function(){a.removeClass("motopress-ce-jumping-fix");clearTimeout(b)},0)},setImage:function(){var a=[],b=this.frame.state().get("selection").models;c.each(b,function(b,
c){a.push(c.attributes.id)});this.ctrl.set(a);this.ctrl.element.trigger("change")}})}(jQuery),function(c){CE.Dialog=can.Construct({myThis:null},{dialogClass:"motopress-dialog",element:c("<div />",{id:"motopress-dialog"}),shortcode:null,oldShortcode:null,dialog:null,minimizeRestoreBtn:c("<button />",{"class":"ui-dialog-titlebar-minimize"}),state:{minimized:"minimized",restored:"restored"},tabs:c("<div />",{id:"motopress-dialog-tabs"}),settingsTitle:c("<li />"),styleTitle:c("<li />"),settingsTab:c("<div />",
{id:"motopress-dialog-settings-tab"}),styleTab:c("<div />",{id:"motopress-dialog-style-tab"}),styleEditorContainer:c("<div />",{id:"motopress-style-editor-container","class":"motopress-hide"}),mode:"tabs",setup:function(){var a=c("<ul />");c("<a />",{href:"#"+this.settingsTab.attr("id"),"class":"motopress-text-no-color-text",text:localStorage.getItem("CESettings")}).append(c("<i />",{"class":"motopress-settings-icon"})).appendTo(this.settingsTitle);c("<a />",{href:"#"+this.styleTab.attr("id"),"class":"motopress-text-no-color-text",
text:localStorage.getItem("CEStyle")}).append(c("<i />",{"class":"motopress-style-icon"})).appendTo(this.styleTitle);a.append(this.settingsTitle,this.styleTitle);this.tabs.append(a,this.settingsTab,this.styleTab).appendTo(this.element);this.styleEditorContainer.appendTo(this.element);this.element.appendTo("body")},setMode:function(a){switch(a){case "tabs":this.styleEditorContainer.addClass("motopress-hide");this.tabs.removeClass("motopress-hide");break;case "style-editor":this.tabs.addClass("motopress-hide"),
this.styleEditorContainer.removeClass("motopress-hide")}this.mode=a;this.updateTitle()},updateTitle:function(){var a=this.shortcode.control();switch(this.getMode()){case "tabs":this.setTitle(a.shortcodeLabel);break;case "style-editor":var b=this.styleEditorContainer.children().control();this.setTitle(a.shortcodeLabel+" - "+b.getTitle())}},getMode:function(){return this.mode},init:function(){CE.Dialog.myThis=this;var a=null,b=!1,d=0,e=parent.MP.Utils.version_compare(c.fn.jquery,"1.9.0","<"),f=sessionStorage.getItem("motopressDialogLeft"),
g=sessionStorage.getItem("motopressDialogTop"),f=null!==f&&null!==g?[parseInt(f),parseInt(g)]:{my:"right-20 top+20",at:"right top",of:window},g=sessionStorage.getItem("motopressDialogWidth"),l=sessionStorage.getItem("motopressDialogHeight");null===g&&(g=300);null===l&&(l=500);c.ui.dialog.prototype._focusTabbable=function(){};this.element.dialog({autoOpen:!1,closeOnEscape:!0,closeText:"",dialogClass:this.dialogClass,draggable:!0,modal:!1,position:f,resizable:!0,minWidth:280,width:g,minHeight:280,height:l,
maxHeight:c(window).height(),create:function(){CE.Dialog.myThis.dialog=CE.Dialog.myThis.element.dialog("widget");a=CE.Dialog.myThis.dialog;a.on("resizestart",function(a,f){b=c(a.originalEvent.target).hasClass("ui-resizable-n");d=c(document).scrollTop();e&&(b||c(this).css("top",parseInt(c(this).css("top"))-d))});a.on("resize",function(a,f){e&&b&&c(this).css("top",parseInt(c(this).css("top"))-d)});a.on("resizestop",function(a,b){CE.Dialog.myThis.savePosition(b);CE.Dialog.myThis.saveSize(b)});c(this).prev(".ui-dialog-titlebar").find(".ui-dialog-titlebar-close").before(CE.Dialog.myThis.minimizeRestoreBtn);
var f=a.draggable("option","cancel")+", .ui-dialog-titlebar-minimize, .ui-dialog-titlebar-restore";a.draggable("option","cancel",f);CE.Dialog.myThis.minimizeRestoreBtn.on("click",function(){c(this).hasClass("ui-dialog-titlebar-minimize")?CE.Dialog.myThis.minimize():CE.Dialog.myThis.restore()})},dragStart:function(a,b){CE.LeftBar.myThis.disable()},dragStop:function(a,b){CE.Dialog.myThis.savePosition(b);CE.LeftBar.myThis.enable()},close:function(){CE.Dialog.myThis.close()},beforeClose:function(a,b){},
open:function(){var b=c("."+CE.Selectable.myThis.selectedClass);b.length&&CE.Selectable.focusWithoutScroll(b.prev());var b=parseInt(sessionStorage.getItem("motopressDialogLeft")),d=parseInt(sessionStorage.getItem("motopressDialogTop")),e=a.width(),f=a.height(),g=c(window).width(),l=c(window).height();f>l&&(f=l,a.height(f));0>d?a.css("top",0):f<l&&d+f>l?a.css("top",l-f):d+f>l?a.css("top",l-f):a.css("top",d);0>b?a.css("left",0):e<g&&b+e>g?a.css("left",g-e):a.css("left",b)},resizeStart:function(){CE.LeftBar.myThis.disable()},
...
a?c("body").trigger("MPCEObjectCreated",[b.element,b.shortcodeName]):c("body").trigger("MPCEObjectUpdated",[b.element,b.shortcodeName]);b.element.trigger("render");d.removeClass(CE.Shortcode.preloaderClass);parent.CE.Save.changeContent();b.groupItemName&&r.accordion.hasClass("ui-accordion")&&(e=r.accordion.accordion("option","active"),r.interact("activate",e))},error:function(a){a=c.parseJSON(a.responseText);c.isPlainObject(a)&&a.hasOwnProperty("message")&&(a.debug?console.log(a.message):(parent.MP.Flash.setFlash(a.message,
"error"),parent.MP.Flash.showMessage()));d.removeClass(CE.Shortcode.preloaderClass)}})}},display:function(a){this.settingsCtrl.display(a);this.stylesCtrl.display(a)}})}(jQuery),function(c){CE.Controls("CE.InlineEditor",{curElement:null,styleFormats:!1,init:function(){c(document).on("mousedown",".mce-tinymce.mce-panel",function(a){a.preventDefault()});c(document).on("keydown",'[data-motopress-shortcode="mp_text"], [data-motopress-shortcode="mp_heading"]',function(a){a.which===c.ui.keyCode.TAB?CE.Selectable.myThis.unselect():
a.which===c.ui.keyCode.ESCAPE&&(CE.InlineEditor.curElement&&CE.InlineEditor.curElement.control().close(!0,"show"),a=c(this).closest(".motopress-clmn").find("."+CE.DragDrop.myThis.helper.attr("class")).first().children("."+CE.DragDrop.myThis.dragHandle.attr("class")),CE.Selectable.focusWithoutScroll(a.prev()),CE.Dialog.myThis.element.dialog("isOpen")||CE.Dialog.myThis.open(a))});c(parent.document).on("mousedown",function(a){CE.InlineEditor.curElement&&!c(a.target).closest(".ui-dialog").length&&CE.InlineEditor.curElement.control().close(!0,
...
CE.LeftBar.myThis.disable();b.hideSplitters();b.hideEmptySpans();c(".motopress-content-wrapper > .motopress-handle-middle-in:last").height("");c(this).find(".motopress-handle-bottom-in").css({bottom:"",height:""});CE.Dialog.myThis.element.dialog("isOpen")&&CE.Dialog.myThis.element.dialog("close");CE.Resizer.myThis.handle=c(g.originalEvent.target);b.oldWidth=parseFloat(h.element.css("width"));f=parent.MP.Utils.getHandleClass(CE.Resizer.myThis.handle.prop("class").split(" "));var m=null,m="ui-resizable-e"===
f||"ui-resizable-se"===f?h.element.next(".motopress-empty"):h.element.prev(".motopress-empty"),k=parent.MP.Utils.getSpanClass(h.element.prop("class").split(" ")),k=parent.MP.Utils.getSpanNumber(k);b.oldSpanNumber=k;var q=0;m&&m.length&&(m=parent.MP.Utils.getSpanClass(m.prop("class").split(" ")),q=parent.MP.Utils.getSpanNumber(m));m=k+q;CE.Resizer.myThis.maxSpanNumber=m;var n=c(this).parent(".motopress-row-edge").width()/100;h.element.resizable("option","maxWidth",n*CE.Grid.myThis.colWidthByNumber[m]);
k=[];for(q=1;q<=m;q++)k[q]=n*CE.Grid.myThis.colWidthByNumber[q];for(var n=Math.floor(m/2),p=0===m%2,q=1;q<=n;q++)0>k[q]-2*CE.Grid.myThis.padding&&(k[q]*=-1,p?q!==n&&(k[m-q]*=-1):k[m-q]*=-1);h.element.data("mp-snap-grid",k);CE.Resizer.myThis.handle.addClass("motopress-resizable-handle-hover");h.element.css({position:"relative",top:0,left:0});c(this).closest(".motopress-row").parent(".motopress-content-wrapper").length||(m=c(this).closest(".motopress-row").nextAll(".motopress-handle-middle-in:last"),
k=parseInt(m.css("min-height")),m.height(k));c("body").trigger("MPCEObjectResizeStart",{objElement:a,objName:e,handle:f})},stop:function(g,h){CE.Utils.removeSceneAction("resize");CE.LeftBar.myThis.enable();b.showSplitters();b.showEmptySpans();CE.Resizer.myThis.splitterHandle=!1;CE.Resizer.myThis.handle.removeClass("motopress-resizable-handle-hover");for(var m={},k=0;k<CE.Resizer.myThis.addedStyleProperties.length;k++)m[CE.Resizer.myThis.addedStyleProperties[k]]="";h.element.css(m);c(this).hasClass("ce_controls")&&
!CE.Dialog.myThis.element.dialog("isOpen")&&(m=h.element.find(".motopress-drag-handle"),CE.Dialog.myThis.open(m));m=h.element.prev(".motopress-empty");k=h.element.next(".motopress-empty");CE.DragDrop.myThis.makeEditableEmptySpan(m.add(k));b.updateSplittableOptions(m,null,null);b.updateSplittableOptions(k,null,null);CE.Resizer.myThis.updateAllHandles();parent.CE.Save.changeContent();c("body").trigger("MPCEObjectResizeStop",{objElement:a,objName:e,handle:f})},resize:function(b,g){switch(f){case "ui-resizable-s":CE.Resizer.myThis.verticalResize(g);
break;case "ui-resizable-w":CE.Resizer.myThis.horizontalResize(f,g);break;case "ui-resizable-e":CE.Resizer.myThis.horizontalResize(f,g);break;case "ui-resizable-sw":CE.Resizer.myThis.verticalResize(g);CE.Resizer.myThis.horizontalResize(f,g);break;case "ui-resizable-se":CE.Resizer.myThis.verticalResize(g),CE.Resizer.myThis.horizontalResize(f,g)}c("body").trigger("MPCEObjectResize",{objElement:a,objName:e,handle:f})}});if(a.length){var g=a.attr("data-motopress-resize");"undefined"===typeof g&&(g=a.attr("data-motopress-group"),
g=CE.LeftBar.myThis.library[g].objects[e].resize);switch(g){case "none":c(this).children(".ui-resizable-handle").addClass("motopress-hide");break;case "horizontal":c(this).children('.ui-resizable-handle:not(".ui-resizable-e, .ui-resizable-w")').addClass("motopress-hide");break;case "vertical":c(this).children('.ui-resizable-handle:not(".ui-resizable-s")').addClass("motopress-hide")}}})},horizontalResize:function(a,b){var c=parseFloat(b.helper.css("width"));b.element.css({top:0,left:0});if(c===this.oldWidth)return!1;
for(var e=c<this.oldWidth?-1:1,f=b.element.data("mp-snap-grid"),g=f.length-1,l=!1,h=1;h<=g;h++)if(!(0>=f[h])&&(l=1===h?0>e?f[h]:Math.abs(f[h+1])-Math.abs(f[h]):h==g?Math.abs(f[h])-Math.abs(f[h-1]):0>e?Math.abs(f[h])-Math.abs(f[h-1]):Math.abs(f[h+1])-Math.abs(f[h]))&&(l=Math.abs(l)/2,c>=f[h]-l/2&&c<=f[h]+l&&(l=h-this.oldSpanNumber,0!==l))){e=null;parent.MP.Utils.getSpanClass(b.element.prop("class").split(" "));CE.Resizer.myThis.changeSpanClass(b.element,parent.CE.Iframe.myThis.gridObj.span["class"]+
h);"ui-resizable-e"===a||"ui-resizable-se"===a?(f="east",e=b.element.next(".motopress-empty")):(f="west",e=b.element.prev(".motopress-empty"));e&&e.length?(f=parent.MP.Utils.getSpanClass(e.prop("class").split(" ")),f=parent.MP.Utils.getSpanNumber(f),l<f?CE.Resizer.myThis.changeSpanClass(e,parent.CE.Iframe.myThis.gridObj.span["class"]+(f-l)):e.remove()):(e=CE.Resizer.myThis.emptySpan.clone(),e.addClass(parent.CE.Iframe.myThis.gridObj.span["class"]+Math.abs(l)).addClass("motopress-empty-hide"),"east"===
f?b.element.after(e):b.element.before(e));b.element.css({width:""});this.oldWidth=c;this.oldSpanNumber=h;break}return!1},verticalResize:function(a){var b=parseInt(a.element.css("min-height")),c=a.helper.height();b===c&&a.element.css("min-height","");a.element.css("min-height",c);a.element.css("height",c)},getMinChildColumn:function(a){var b=CE.Grid.myThis.columnCount;a.find(".motopress-clmn").each(function(){var a=parent.MP.Utils.getSpanNumber(parent.MP.Utils.getSpanClass(c(this).prop("class").split(" ")));
...
t.length&&t.each(function(){y=c(this).attr("data-motopress-shortcode");z.involvedElements.hasOwnProperty(y)||(z.involvedElements[y]=[]);z.involvedElements[y].push(this)}));c("body").trigger("MPCEObjectSplitStart",z)},stop:function(a,d){CE.Utils.removeSceneAction("split");CE.LeftBar.myThis.enable();b.showSplitters();b.showEmptySpans();d.helper.closest(".motopress-row").find(".motopress-drag-handle").css("cursor","move");c(this).removeClass("motopress-splitter-hover");var h=c(this).closest(".motopress-clmn"),
m=h.prev(".motopress-clmn");CE.Resizer.myThis.updateSplittableOptions(h,null,null,"split");CE.Resizer.myThis.updateAllHandles();f&&e.length&&e.remove();parent.CE.Save.changeContent();var k,q={involvedElements:{}};h.length&&(h=h.find(".motopress-block-content > [data-motopress-shortcode]"),h.length&&h.each(function(){k=c(this).attr("data-motopress-shortcode");q.involvedElements.hasOwnProperty(k)||(q.involvedElements[k]=[]);q.involvedElements[k].push(this)}));m.length&&(h=m.find(".motopress-block-content > [data-motopress-shortcode]"),
h.length&&h.each(function(){k=c(this).attr("data-motopress-shortcode");q.involvedElements.hasOwnProperty(k)||(q.involvedElements[k]=[]);q.involvedElements[k].push(this)}));c("body").trigger("MPCEObjectSplitStop",q)},drag:function(a,l){var h=!1,m=l.offset.left-CE.Grid.myThis.padding/2;null===d&&(d=m);if(m!==d){var k=c(this).closest(".motopress-clmn"),q=null,n=k.closest(".motopress-row-edge").width(),p,r,t=c(this).data("mp-snap-grid"),u=t.length-1,v=CE.LeftBar.myThis.getSpace();1<u?(p=Math.abs(t[2])-
Math.abs(t[1]),r=Math.abs(t[u])-Math.abs(t[u-1])):p=r=n/100*CE.Grid.myThis.colWidthByNumber[1];p>CE.Grid.myThis.padding&&(p-=CE.Grid.myThis.padding);p>CE.Grid.myThis.padding&&(p-=CE.Grid.myThis.padding);r>CE.Grid.myThis.padding&&(r-=CE.Grid.myThis.padding);p=a.pageX<=v+2||m<=Math.abs(t[1])-p;r=a.pageX>=c(document).width()-2||m>=Math.abs(t[u])+1.5*r;if(p||r){if(p&&"left"===b.curSplitterArea||r&&"right"===b.curSplitterArea)return;q=k.prev(".motopress-clmn");m=parent.MP.Utils.getSpanClass(k.prop("class").split(" "));
...
m),b.currentI=m,c(window).trigger("resize"),h=!0)}}else for(b.curSplitterArea="center",v=m<d?-1:1,r=!1,p=1;p<=u;p++)if(!(0>=t[p])&&(r=!1,r=1<u?1===p?Math.abs(t[p+1])-Math.abs(t[p]):p==u?Math.abs(t[p])-Math.abs(t[p-1]):0>v?Math.abs(t[p])-Math.abs(t[p-1]):Math.abs(t[p+1])-Math.abs(t[p]):n/100*CE.Grid.myThis.colWidthByNumber[1])&&(r=Math.abs(r)/2,m>=t[p]-r/2&&m<=t[p]+r&&(r=p-b.currentI,f=!1,0!==r))){k=c(this).closest(".motopress-clmn");q=k.prev(".motopress-clmn");m=parent.MP.Utils.getSpanClass(k.prop("class").split(" "));
...
c+=f-g}c+=parseFloat(e.css("padding-"+b));return c+=parseFloat(e.css("border-"+b+"-width"))},updateHandle:function(){var a=setTimeout(function(){if(!CE.DragDrop.myThis.isEmptyScene()){var b=c(".motopress-content-wrapper > .motopress-row:first"),d=b.offset(),e=parseFloat(b.css("margin-left")),f=c(".motopress-content-wrapper > .motopress-row:last"),g=CE.LeftBar.myThis.getSpace(),l=d.left-g;c(".motopress-content-wrapper > .motopress-row").each(function(){var a=c(this),b=a.outerHeight();parent.MP.Utils.getEdgeRow(a).children(".motopress-clmn:first, .motopress-clmn:last").each(function(){var d=
c(this),e=parent.MP.Utils.getEdgeSpan(d),f=e.offset().top-a.offset().top+parseFloat(e.css("border-top-width"));d.children(".motopress-wrapper-helper, .motopress-helper").each(function(){var a=c(this).hasClass("motopress-wrapper-helper");c(this).find(".motopress-handle-left, .motopress-handle-right").each(function(){var d=c(this).hasClass("motopress-handle-left")?"left":"right",h=parseFloat(e.css("border-"+d+"-width")),k="left"===d?e.offset().left-g:c(window).width()-e.offset().left-e.outerWidth(),
l=k+h+CE.Grid.myThis.padding;0>=Math.floor(l)&&(l=25,k=0);l={top:-f,width:l,height:b};l[d]=-(a?k+h:k+h+CE.Grid.myThis.padding);c(this).css(l)})})})});var h=c("html"),m=c(document),k=m.width()-g,q=c(".motopress-content-wrapper > .motopress-handle-middle-in:first"),n=c(".motopress-content-wrapper > .motopress-handle-middle-in:last"),p=n.prevAll(".motopress-handle-middle-in:first");p[0]!==q[0]&&p.css({width:"",left:"",height:"","margin-top":""});var p=m.height(),r=parseInt(h.css("top")),h=p-n.offset().top;
p<r+m.outerHeight(!0)&&(h+=r);f=parseInt(f.css("margin-bottom"));Math.abs(parseInt(n.css("margin-top")))!==f&&(h+=f);b=parseInt(b.css("margin-top"));q.css({width:k,height:d.top,top:b-d.top,left:-l+e,"margin-top":""});n.css({width:k,left:-l+e,height:h,"margin-top":-f})}clearTimeout(a)},50)},updateBottomInHandleMiddle:function(){var a=setTimeout(function(){CE.DragDrop.myThis.isEmptyScene()||c(".motopress-content-wrapper > .motopress-row").each(function(){CE.Resizer.myThis.setHandleHeight(c(this))});
...
CE.LeftBar.myThis.disable();b.showOuterHandles();b.canDrop=!0;CE.Selectable.myThis.unselect(d);c(".motopress-splitter").addClass("motopress-hide");c(this).css("opacity",.3);c(".motopress-content-wrapper .motopress-clmn .motopress-drag-handle").addClass("motopress-start-drag")},stop:function(a,f){CE.Utils.removeSceneAction("drag");CE.LeftBar.myThis.enable();b.hideOuterHandles();c(".motopress-splitter").removeClass("motopress-hide");c(this).css("opacity","");c(".motopress-content-wrapper .motopress-clmn .motopress-drag-handle").removeClass("motopress-start-drag");
CE.Selectable.myThis.select(d);CE.DragDrop.myThis.helperContainer.children().hide()},drag:function(){CE.DragDrop.myThis.onDrag()}}).removeClass("ui-draggable")},makeDraggableNewBlock:function(){var a=this,b={top:-10,left:-10},d=c(".motopress-content-wrapper:first"),e=d.length?d.offset().top:0;c(".motopress-ce-object").draggable({cursor:"move",cursorAt:b,helper:"clone",zIndex:10002,appendTo:".motopress-content-wrapper:first",start:function(d,g){CE.Utils.addSceneAction("drag");CE.LeftBar.myThis.disable();
a.showOuterHandles();a.canDrop=!0;g.position.top=d.pageY-e-b.top;var l=c(".motopress-content-wrapper .motopress-clmn .motopress-drag-handle."+CE.Selectable.myThis.selectedClass);l.length&&CE.Selectable.myThis.unselect(l);c(".motopress-empty-scene-type-here").addClass("motopress-empty-scene-type-here-nohover");g.helper.children(".motopress-ce-object-inner").css("cssText","box-shadow: none !important");c(".motopress-splitter").addClass("motopress-hide");c(".motopress-content-wrapper .motopress-clmn .motopress-drag-handle").addClass("motopress-start-drag");
g.helper.data("dropped",!1)},stop:function(b,d){CE.Utils.removeSceneAction("drag");CE.LeftBar.myThis.enable();a.hideOuterHandles();c(".motopress-empty-scene-type-here").removeClass("motopress-empty-scene-type-here-nohover");c(".motopress-splitter").removeClass("motopress-hide");c(".motopress-content-wrapper .motopress-clmn .motopress-drag-handle").removeClass("motopress-start-drag");!1===d.helper.data("dropped")&&CE.DragDrop.myThis.dropOnStageHandler(b,d)&&parent.CE.Save.changeContent();CE.DragDrop.myThis.helperContainer.children().hide()},
drag:function(a,c){c.position.top=a.pageY-e-b.top;CE.DragDrop.myThis.onDrag()}})},onDrag:function(){var a=this.container.find(".motopress-droppable-hover");if(a.length){if(a=a.attr("data-motopress-position"),null!==a){var a=".motopress-line-helper-"+a+", .motopress-text-helper-"+a,b=this.helperContainer.children();b.not(a).hide();b.filter(a).show()}}else this.helperContainer.children().hide()},dropOnStageHandler:function(a,b){var d=b.helper.hasClass("motopress-ce-object"),e=c(".motopress-content-wrapper").find(".motopress-handle-middle-in:last");
if(d&&e&&e.hasClass("motopress-handle-middle-in")){var f,g=CE.DragDrop.myThis,l=g.newBlock.clone();"mp_space"===b.helper.attr("data-motopress-shortcode")&&l.addClass(g.spaceClass);g.makeEditable(l,b,!0);parent.MP.Utils.getSpanClass(l.prop("class").split(" "));f=CE.DragDrop.myThis.rowHtml.clone().find(".motopress-filler-content").replaceWith(l).end();e.after(f);CE.DragDrop.myThis.makeRowEditable(f,d);var h=setTimeout(function(){g.addHandleMiddle(f,"motopress-content-wrapper");g.resize(void 0,l,"middle");
var a=l.find(".motopress-drag-handle");CE.Selectable.myThis.select(a);g.makeDroppable();CE.Resizer.myThis.updateSplittableOptions(l,void 0,f);CE.Resizer.myThis.updateAllHandles();clearTimeout(h)},0);return!0}return!1},makeEmptySceneHelperDroppable:function(){var a=this;this.emptySceneDroppable.droppable({accept:".motopress-ce-object",tolerance:"pointer",drop:function(b,d){if(a.canDrop)a.canDrop=!1;else return!1;CE.DragDrop.myThis.emptySceneHelper.hide();c(this).css("opacity",1);var e=c(this).closest(".motopress-clmn");
0==e.length&&(e=c(this));var f=parent.MP.Utils.getSpanClass(e.prop("class").split(" ")),g=e=null,l=c(this).closest(".motopress-row"),h=null,m=d.draggable.hasClass("motopress-ce-object");m?(h=CE.DragDrop.myThis.newBlock.clone(),"mp_space"===d.draggable.attr("data-motopress-shortcode")&&h.addClass(CE.DragDrop.myThis.spaceClass),CE.DragDrop.myThis.makeEditable(h,d,!0),g=null):(h=d.draggable,g=h.parent(".motopress-row"));var e=parent.MP.Utils.getSpanClass(h.prop("class").split(" ")),e=CE.DragDrop.myThis.removeEmptyBlocks(h,
e),k=!1;null==f&&(f=parent.CE.Iframe.myThis.gridObj.span.fullclass,k=!0);l=CE.DragDrop.myThis.rowHtml.clone().find(".motopress-filler-content").replaceWith(h).end();c(".motopress-content-wrapper").append(l);CE.DragDrop.myThis.makeRowEditable(l,m);var q=setTimeout(function(){g=CE.DragDrop.myThis.clearIfEmpty(g);k&&(f="motopress-content-wrapper");CE.DragDrop.myThis.addHandleMiddle(l,f);CE.DragDrop.myThis.resize(g,h,"middle");clearTimeout(q)},0),n=setTimeout(function(){var a=h.find(".motopress-drag-handle");
CE.Selectable.myThis.select(a);CE.DragDrop.myThis.makeDroppable();CE.Resizer.myThis.updateSplittableOptions(h,g,l);CE.Resizer.myThis.updateAllHandles();clearTimeout(n)},0);parent.CE.Save.changeContent();CE.Utils.removeSceneState("empty-scene")},over:function(){c(this).css("opacity",.5)},out:function(){c(this).css("opacity",1)}})},makeDroppable:function(){var a=this;c(".motopress-content-wrapper").find(".motopress-handle-intermediate, .motopress-handle-left, .motopress-handle-top-in, .motopress-handle-bottom-in, .motopress-handle-left-out, .motopress-handle-right-out, .motopress-handle-left-in, .motopress-handle-right-in, .motopress-handle-middle-in, .motopress-handle-insert, .motopress-handle-right").droppable({accept:".motopress-clmn, .motopress-ce-object",
tolerance:"pointer",hoverClass:"motopress-droppable-hover",drop:function(b,d){var e=c(this).attr("data-motopress-position");if("undefined"!==typeof a.hoveredHandles&&1<a.hoveredHandles.length&&a.hoveredHandles.filter(".motopress-handle-left, .motopress-handle-right").length)if(-1<c.inArray(e,["left","right"]))a.canDrop=!0;else return!1;if(a.canDrop)a.canDrop=!1;else return!1;d.helper.data("dropped",!0);var f=c(this).closest(".motopress-clmn");0===f.length&&(f=c(this));var g=parent.MP.Utils.getSpanClass(f.prop("class").split(" ")),
l=null,h=null,m=c(this).closest(".motopress-row"),l=parent.MP.Utils.getEdgeRow(m),k=null,q=null,n=null,p=null,r=d.draggable.hasClass("motopress-ce-object");r?(n=null,p=CE.DragDrop.myThis.newBlock.clone(),"mp_space"===d.draggable.attr("data-motopress-shortcode")&&p.addClass(CE.DragDrop.myThis.spaceClass),CE.DragDrop.myThis.makeEditable(p,d,!0),h=null):(n=d,p=n.draggable,h=p.closest(".motopress-row"));var t,q=null;null!==h&&(k=parent.MP.Utils.getEdgeRow(h).children(".motopress-clmn").index(p),q=p.prev(),
q.length&&q.hasClass("motopress-empty")&&k--);q=l.children(".motopress-clmn");l=parent.MP.Utils.getSpanClass(p.prop("class").split(" "));l=CE.DragDrop.myThis.removeEmptyBlocks(p,l);switch(e){case "top-in":if(!1!==(t=CE.DragDrop.myThis.canBeMoved(h,null,k,0,n))){e=CE.DragDrop.myThis.rowInnerHtml.clone().find(".motopress-filler-content").replaceWith(p).end();k=CE.DragDrop.myThis.spanHtml.clone().addClass(g);CE.DragDrop.setEdgeSpan(k);f.before(k);var u=CE.DragDrop.myThis.rowInnerHtml.clone().find(".motopress-filler-content").replaceWith(f).end();
k.find(".motopress-filler-content").replaceWith(u);u.before(e);CE.DragDrop.myThis.makeRowEditable(e.add(u),r);k.attr({"data-motopress-wrapper-id":CE.DragDrop.myThis.wrapperId}).prepend(CE.DragDrop.myThis.wrapperHelperResizer.clone());CE.DragDrop.myThis.resizer.makeSplittable(k);f=null;k.closest(".motopress-row").parent(".motopress-content-wrapper").length?(f=CE.DragDrop.myThis.wrapperHelper.clone(),k.prepend(f)):f=k.closest('.motopress-clmn:has(".motopress-wrapper-helper")').children(".motopress-wrapper-helper");
CE.DragDrop.myThis.makeEditable(k,d,!0);CE.DragDrop.myThis.wrapperId++;var v=setTimeout(function(){h=CE.DragDrop.myThis.clearIfEmpty(h);CE.DragDrop.myThis.addHandleMiddle(u,g);CE.DragDrop.myThis.resize(h,p,"top-in",t);clearTimeout(v)},0)}break;case "bottom-in":!1!==(t=CE.DragDrop.myThis.canBeMoved(h,null,k,0,n))&&(e=CE.DragDrop.myThis.rowInnerHtml.clone().find(".motopress-filler-content").replaceWith(p).end(),k=CE.DragDrop.myThis.spanHtml.clone().addClass(g),CE.DragDrop.setEdgeSpan(k),f.before(k),
u=CE.DragDrop.myThis.rowInnerHtml.clone().find(".motopress-filler-content").replaceWith(f).end(),k.find(".motopress-filler-content").replaceWith(u),u.after(e),CE.DragDrop.myThis.makeRowEditable(e.add(u),r),k.attr({"data-motopress-wrapper-id":CE.DragDrop.myThis.wrapperId}).prepend(CE.DragDrop.myThis.wrapperHelperResizer.clone()),CE.DragDrop.myThis.resizer.makeSplittable(k),f=null,k.closest(".motopress-row").parent(".motopress-content-wrapper").length?(f=CE.DragDrop.myThis.wrapperHelper.clone(),k.prepend(f)):
f=k.closest('.motopress-clmn:has(".motopress-wrapper-helper")').children(".motopress-wrapper-helper"),CE.DragDrop.myThis.makeEditable(k,d,!0),CE.DragDrop.myThis.wrapperId++,v=setTimeout(function(){h=CE.DragDrop.myThis.clearIfEmpty(h);CE.DragDrop.myThis.addHandleMiddle(u,g);CE.DragDrop.myThis.resize(h,p,"bottom-in",t);clearTimeout(v)},0));break;case "left-out":case "left":case "intermediate":q="left"===e?0:q.index(f);!1!==(t=CE.DragDrop.myThis.canBeMoved(h,m,k,0>q?0:q,n,"out"))&&(f.parent().length&&
f.before(p),v=setTimeout(function(){h=CE.DragDrop.myThis.clearIfEmpty(h);if(null===h||h[0]!==m[0])CE.DragDrop.myThis.resize(h,p,"left-out",t);else{var a=parent.MP.Utils.calcSpanNumber(h,n);CE.Resizer.myThis.changeSpanClass(p,parent.CE.Iframe.myThis.gridObj.span["class"]+(parent.CE.Iframe.myThis.gridObj.row.col-a))}clearTimeout(v)},0));break;case "right-out":case "right":q="right"===e?q.length:q.index(f)+1;!1!==(t=CE.DragDrop.myThis.canBeMoved(h,m,k,q,n,"out"))&&(f.parent().length&&f.after(p),v=setTimeout(function(){h=
CE.DragDrop.myThis.clearIfEmpty(h);if(null===h||h[0]!==m[0])CE.DragDrop.myThis.resize(h,p,"right-out",t);else{var a=parent.MP.Utils.calcSpanNumber(h,n);CE.Resizer.myThis.changeSpanClass(p,parent.CE.Iframe.myThis.gridObj.span["class"]+(parent.CE.Iframe.myThis.gridObj.row.col-a))}clearTimeout(v)},0));break;case "left-in":q=0;1<parent.MP.Utils.getSpanNumber(g)&&!1!==(t=CE.DragDrop.myThis.canBeMoved(h,m,k,q,n,"left-in",f))&&(k=CE.DragDrop.myThis.spanHtml.clone().addClass(g),CE.DragDrop.setEdgeSpan(k),
...
k.prepend(f)):f=k.closest('.motopress-clmn:has(".motopress-wrapper-helper")').children(".motopress-wrapper-helper"),CE.DragDrop.myThis.makeEditable(k,d,!0),CE.DragDrop.myThis.wrapperId++,v=setTimeout(function(){h=CE.DragDrop.myThis.clearIfEmpty(h);CE.DragDrop.myThis.addHandleMiddle(u,g);CE.DragDrop.myThis.resize(h,p,"left-in",t);clearTimeout(v)},0));break;case "right-in":q=1;1<parent.MP.Utils.getSpanNumber(g)&&!1!==(t=CE.DragDrop.myThis.canBeMoved(h,m,k,q,n,"right-in",f))&&(k=CE.DragDrop.myThis.spanHtml.clone().addClass(g),
CE.DragDrop.setEdgeSpan(k),f.before(k),u=CE.DragDrop.myThis.rowInnerHtml.clone().find(".motopress-filler-content").replaceWith(f).end(),k.find(".motopress-filler-content").replaceWith(u),f.after(p),CE.DragDrop.myThis.makeRowEditable(u,r),k.attr({"data-motopress-wrapper-id":CE.DragDrop.myThis.wrapperId}).prepend(CE.DragDrop.myThis.wrapperHelperResizer.clone()),CE.DragDrop.myThis.resizer.makeSplittable(k),f=null,k.closest(".motopress-row").parent(".motopress-content-wrapper").length?(f=CE.DragDrop.myThis.wrapperHelper.clone(),
k.prepend(f)):f=k.closest('.motopress-clmn:has(".motopress-wrapper-helper")').children(".motopress-wrapper-helper"),CE.DragDrop.myThis.makeEditable(k,d,!0),CE.DragDrop.myThis.wrapperId++,v=setTimeout(function(){h=CE.DragDrop.myThis.clearIfEmpty(h);CE.DragDrop.myThis.addHandleMiddle(u,g);CE.DragDrop.myThis.resize(h,p,"right-in",t);clearTimeout(v)},0));break;case "middle-in":if(!1!==(t=CE.DragDrop.myThis.canBeMoved(h,null,k,0,n))){var s=!1;null==g&&(g=parent.CE.Iframe.myThis.gridObj.span.fullclass+
" motopress-clmn",s=!0);var x=parseInt(c(this).css("min-height"));c(this).siblings(".motopress-handle-middle-in").add(this).each(function(){c(this).height(x)});c(".motopress-content-wrapper > .motopress-handle-middle-in:last").height("");m=c(this).parent(".motopress-content-wrapper").length?CE.DragDrop.myThis.rowHtml.clone().find(".motopress-filler-content").replaceWith(p).end():CE.DragDrop.myThis.rowInnerHtml.clone().find(".motopress-filler-content").replaceWith(p).end();c(this).after(m);CE.DragDrop.myThis.makeRowEditable(m,
r);l=parent.MP.Utils.getEdgeRow(m);v=setTimeout(function(){h=CE.DragDrop.myThis.clearIfEmpty(h);s&&(g="motopress-content-wrapper");CE.DragDrop.myThis.addHandleMiddle(m,g);CE.DragDrop.myThis.resize(h,p,"middle",t);clearTimeout(v)},0)}break;case "insert":r=parent.MP.Utils.getSpanClass(f.prop("class").split(" ")),f.parent().length&&f.replaceWith(p),a.resizer.changeSpanClass(p,r),q=q.index(f),h&&(t=CE.DragDrop.myThis.canBeMoved(h,null,k,q,n,"insert"),v=setTimeout(function(){h=CE.DragDrop.myThis.clearIfEmpty(h);
CE.DragDrop.myThis.resize(h,p,"insert",t);clearTimeout(v)},0))}var y=setTimeout(function(){var b=p.find(".motopress-drag-handle");CE.Selectable.myThis.select(b);CE.DragDrop.myThis.makeDroppable();CE.Resizer.myThis.updateSplittableOptions(p,h,m);CE.Resizer.myThis.updateAllHandles();c(window).trigger("resize");var d,e={involvedElements:{}};e.droppedElement=p;h&&h.length&&(b=h.find(".motopress-block-content > [data-motopress-shortcode]"),b.length&&b.each(function(){d=c(this).attr("data-motopress-shortcode");
e.involvedElements.hasOwnProperty(d)||(e.involvedElements[d]=[]);-1===c.inArray(this,e.involvedElements[d])&&e.involvedElements[d].push(this)}));m&&m.length&&(b=m.find(".motopress-block-content > [data-motopress-shortcode]"),b.length&&b.each(function(){d=c(this).attr("data-motopress-shortcode");e.involvedElements.hasOwnProperty(d)||(e.involvedElements[d]=[]);-1===c.inArray(this,e.involvedElements[d])&&e.involvedElements[d].push(this)}));a.bodyEl.trigger("MPCEObjectDrop",e);clearTimeout(y)},0);parent.CE.Save.changeContent()},
over:function(){a.hoveredHandles=a.container.find(".motopress-droppable-hover");var b=c(this).attr("data-motopress-position"),d="middle-in"!==b?c(this).closest(".motopress-clmn"):c(this);CE.DragDrop.myThis.showLineTextHelper(d,b)},out:function(){a.hoveredHandles=a.container.find(".motopress-droppable-hover");c(this).attr("data-motopress-position");a.onDrag()}})},showLineTextHelper:function(a,b){var d=a.offset(),e=d.left,f=d.top,d=a.closest(".motopress-row"),g=parent.MP.Utils.getEdgeRow(d),d=g.height(),
l=g.offset().top,h=parseFloat(g.css("border-top-width")),g=parseFloat(g.css("padding-top")),m,k,q,n;0<=c.inArray(b,["intermediate","left-out","right-out","left","right"])&&(q=Math.floor(a.children(".motopress-helper, .motopress-wrapper-helper").find(".motopress-handle-intermediate").width()),4<q?(m=2,k=q-4,q-=m):(m=1,k=q),n=0,CE.Grid.myThis.padding||(n=m/2));switch(b){case "intermediate":this.lineHelperIntermediate.css({width:k,height:d,top:l+g+h,left:Math.ceil(e+CE.Grid.myThis.padding-q-n)}).show();
this.textHelperIntermediate.css({top:this.lineHelperIntermediate.offset().top,left:this.lineHelperIntermediate.offset().left+k}).show();break;case "left":case "left-out":"left"===b?(f=this.lineHelperLeft,n=this.textHelperLeft):(f=this.lineHelperLeftOut,n=this.textHelperLeftOut);q=e+CE.Grid.myThis.padding+1;k=0;f.css({width:k,height:d,top:l+g+h,left:q}).show();n.css({top:f.offset().top,left:q+k}).show();break;case "right":case "right-out":"right"===b?(f=this.lineHelperRight,n=this.textHelperRight):
(f=this.lineHelperRightOut,n=this.textHelperRightOut);k=c(document).width();q=e+a.outerWidth()-CE.Grid.myThis.padding;q>=k&&(q=k-1);k=0;e=q-n.outerWidth();f.css({width:k,height:d,top:l+g+h,left:q}).show();n.css({top:f.offset().top,left:e}).show();break;case "left-in":this.lineHelperLeftIn.css({height:a.outerHeight(),top:f,left:e+CE.Grid.myThis.padding}).show();this.textHelperLeftIn.css({top:this.lineHelperLeftIn.offset().top,left:this.lineHelperLeftIn.offset().left+this.lineHelperThickness}).show();
break;case "right-in":this.lineHelperRightIn.css({height:a.outerHeight(),top:f,left:e+a.outerWidth()-this.lineHelperThickness-CE.Grid.myThis.padding}).show();this.textHelperRightIn.css({top:this.lineHelperRightIn.offset().top,left:this.lineHelperRightIn.offset().left-this.textHelperRightIn.outerWidth()}).show();break;case "top-in":this.lineHelperTopIn.css({width:a.outerWidth(),top:f,left:e}).show();this.textHelperTopIn.css({top:f,left:e}).show();break;case "bottom-in":this.lineHelperBottomIn.css({width:a.outerWidth(),
top:f+a.outerHeight()-this.lineHelperThickness,left:e}).show();this.textHelperBottomIn.css({top:this.lineHelperBottomIn.offset().top,left:this.lineHelperBottomIn.offset().left}).show();break;case "middle-in":q=a.outerWidth();k=a.height()-2*parseInt(this.lineHelperHandleMiddle.css("outline-width"));d=f+parseInt(this.lineHelperHandleMiddle.css("outline-width"));l=e-CE.Grid.myThis.padding;e=c(".motopress-content-wrapper > .motopress-handle-middle-in:first");if(a[0]===e[0]||a[0]===c(".motopress-content-wrapper > .motopress-handle-middle-in:last")[0])k=
c(".motopress-content-wrapper"),l=k.offset(),k.find(".motopress-row"),q=k.width(),k=20,a[0]===e[0]&&(d=l.top-k),l=l.left-CE.Grid.myThis.padding;this.lineHelperHandleMiddle.css({width:q+2*CE.Grid.myThis.padding,height:k,top:d,left:l}).show();e=this.lineHelperHandleMiddle.offset();this.textHelperHandleMiddle.css({top:e.top,left:e.left}).show();break;case "insert":q=e+CE.Grid.myThis.padding,e=q-this.textHelperInsert.outerWidth(),0>e&&(e=q+a.width()+1),this.lineHelperInsert.css({width:a.width(),height:a.outerHeight(),
left:q,top:f}).show(),this.textHelperInsert.css({top:this.lineHelperInsert.offset().top,left:e}).show()}},removeEmptyBlocks:function(a,b){var c=a.prev(".motopress-empty"),e=a.next(".motopress-empty"),f=0,g=0;"undefined"!=typeof c[0]&&(f=parent.MP.Utils.getSpanNumber(parent.MP.Utils.getSpanClass(c.prop("class").split(" "))));"undefined"!=typeof e[0]&&(g=parent.MP.Utils.getSpanNumber(parent.MP.Utils.getSpanClass(e.prop("class").split(" "))));if("undefined"!=typeof c[0]||"undefined"!=typeof e[0])a.removeClass(b),
b=parent.CE.Iframe.myThis.gridObj.span["class"]+(parent.MP.Utils.getSpanNumber(b)+f+g),a.addClass(b),c.remove(),e.remove();return b},clearIfEmpty:function(a,b){"undefined"===typeof b&&(b="default");if(null!==a){var d=parent.MP.Utils.getEdgeRow(a),e=a.parent(),d=d.children(".motopress-clmn");if(!d.length){for(d=0;0===a.parent(".motopress-content-wrapper").length&&!a.siblings(".motopress-row, .motopress-clmn").length&&!a.parent(".motopress-content-wrapper").length;){if(a.parent(".motopress-clmn").length){var f=
...
a.prev(".motopress-handle-middle-in").remove().end().remove();if("undefined"!==typeof e&&null!==e&&!e.hasClass("motopress-content-wrapper")){var g=e.children(".motopress-row");if(1===g.length&&(g=parent.MP.Utils.getEdgeRow(g).children(".motopress-clmn:not(.motopress-empty)"),1===g.length)){parent.MP.Utils.getSpanClass(g.prop("class").split(" "));var l=parent.MP.Utils.getSpanClass(e.prop("class").split(" "));CE.Resizer.myThis.changeSpanClass(g,l);e.replaceWith(g)}}return d?f:a}if(1===d.length&&!a.parent(".motopress-content-wrapper").length){var h,
m,k,q=null;d.parentsUntil(".motopress-content-wrapper",".motopress-clmn").each(function(){h=c(this).children(".motopress-row");m=c(this).siblings(".motopress-clmn");k=c(this).closest(".motopress-row").parent(".motopress-content-wrapper");if(1===h.length&&(m.length||k.length))return q=c(this),!1});null!==q&&(parent.MP.Utils.getSpanClass(d.prop("class").split(" ")),e=parent.MP.Utils.getSpanClass(q.prop("class").split(" ")),CE.Resizer.myThis.changeSpanClass(d,e),q.replaceWith(d),a="remove"===b?{row:q.parent()}:
null)}}return a},recursiveAddHandleMiddle:function(a){a.children(".motopress-row").each(function(a){var d=CE.DragDrop.myThis.handleMiddleIn;0==a&&c(this).before(d.clone());c(this).next(".mpce-wp-more-tag").length?c(this).next(".mpce-wp-more-tag").after(d.clone()):c(this).after(d.clone());parent.MP.Utils.getEdgeRow(c(this)).children(".motopress-clmn").each(function(){parent.MP.Utils.getEdgeSpan(c(this)).children(".motopress-row").length&&CE.DragDrop.myThis.recursiveAddHandleMiddle(parent.MP.Utils.getEdgeSpan(c(this)))})})},
addHandleMiddle:function(a,b){a.parent(("undefined"===typeof b?"":"."+b)+".motopress-clmn, .motopress-content-wrapper").children(".motopress-row").each(function(a){var b=null,b=CE.DragDrop.myThis.handleMiddleIn;0==a&&(a=c(this).prevAll(".motopress-handle-middle-in"),0==a.length?(c(this).before(b.clone()),c(this).parent().is("[data-motopress-wrapper-id]")&&CE.DragDrop.myThis.setCalcWrapperWidth(c(this).prev())):a.each(function(a,b){0!=a&&c(b).remove()}));b=b.clone();a=c(this).nextUntil(".motopress-row",
".motopress-handle-middle-in");0==a.length?(c(this).next(".mpce-wp-more-tag").length?c(this).next(".mpce-wp-more-tag").after(b):c(this).after(b),c(this).parent().is("[data-motopress-wrapper-id]")&&CE.DragDrop.myThis.setCalcWrapperWidth(b)):a.each(function(a,b){0!=a&&c(b).remove()})})},getMinAllowedSpanSize:function(a,b,c){for(var e=1,f,g=1;g<=parent.CE.Iframe.myThis.gridObj.row.col;g++)if(e=g,b){if(f=a/100*CE.Grid.myThis.colWidthByNumber[g],this.resizer.isAllowedColSize(c,f))break}else if(this.resizer.isAllowedColSize(g,
a))break;return e},canBeMoved:function(a,b,d,e,f,g,l,h){var m,k;k="undefined"===typeof a||a instanceof jQuery&&!a.length?parent.MP.Utils.getEdgeRow(a):a=null;m="undefined"===typeof b||b instanceof jQuery&&!b.length?parent.MP.Utils.getEdgeRow(b):b=null;d="undefined"===typeof d?null:d;e="undefined"===typeof e?null:e;f="undefined"===typeof f?null:f;g="undefined"===typeof g?!1:g;h="undefined"===typeof h?!1:h;l="undefined"===typeof l?null:l;var q={},n=parent.CE.Iframe.myThis.gridObj.row.col,p=0,r=!0;if(null!==
b){if(g&&"out"===g&&null!==k&&k[0]===m[0])return!0;m.children(".motopress-clmn").each(function(){parent.MP.Utils.notClone(c(this),f)&&p++})}if(p<n||null===m){var t=this,u,v,s,x,y,z,J,G=[];b=[];var D,E,I=null,K=null,B=[],A=[],F=0;if(null!==a){u=-1;D=parseFloat(a.css("width"));F=k.children(".motopress-clmn");a=F.length-1;J=!0;g&&"insert"===g&&(a++,m=null,J=!1);var M=!1;if(m){var w=m.closest(".motopress-row-edge");k[0]===w[0]&&(M=!0)}if(1<=a){var L=this.getMinAllowedSpanSize(D,!1);z=y=0;x=!1;v=t.getSpanSizeRules(a);
var N=!1;!g||"left-in"!==g&&"right-in"!==g||(N=!0);F.each(function(a){a===d&&J||(u++,s={},s.index=u,s.isWrapper=c(this).is("[data-motopress-wrapper-id]"),s.size=v[u],s.isWrapper?(M&&c(this).find(".motopress-row-edge").each(function(){c(this)[0]===m[0]&&(I=u)}),s.wrapperWidth=D/100*CE.Grid.myThis.colWidthByNumber[v[u]],s.minSpan=t.resizer.getMinChildColumn(c(this)),s.minSize=t.getMinAllowedSpanSize(D,!0,s.minSpan),s.isAllowed=t.resizer.isAllowedColSize(s.minSpan,s.wrapperWidth)):(s.minSize=L,N&&this===
l[0]&&1>=s.minSize&&(s.minSize=2),s.isAllowed=t.resizer.isAllowedColSize(v[u],D)),s.size<s.minSize?y+=s.minSize-s.size:z+=s.size-s.minSize,x||s.isAllowed||(x=!0),B.push(s))});if(x)if(y>z)r=!1;else{for(F=a=k=0;2*y!==k+a;){for(w=0;w<B.length;w++)B[w].isAllowed&&B[w].size>B[w].minSize&&k<y?(B[w].size--,k++):!B[w].isAllowed&&B[w].size<B[w].minSize&&(B[w].size++,a++);if(50<=++F){r=!1;break}}for(w=0;w<B.length;w++)G.push(B[w].size);q.from=G}null!==I&&(K=G.length?D/100*CE.Grid.myThis.colWidthByNumber[G[I]]:
D/100*CE.Grid.myThis.colWidthByNumber[v[I]])}}if(r){var H;if(g&&"out"!==g&&"insert"!==g)switch(g){case "left-in":case "right-in":for(E=parseFloat(l.css("width")),v=t.getSpanSizeRules(2),w=0;w<v.length;w++)if(H=this.getMinAllowedSpanSize(E,!1,v[w]),v[w]<H){r=!1;break}}else if(null!==m){E=K?K:parseFloat(m.css("width"));g=m.children(".motopress-clmn");var G=g.length,C;u=-1;v=t.getSpanSizeRules(p+1);H=this.getMinAllowedSpanSize(E,!1);z=y=0;x=!1;C={index:e,isWrapper:!1,size:v[e],minSize:H,isAllowed:v[e]>=
H};C.size<C.minSize?y+=C.minSize-C.size:z+=C.size-C.minSize;g.each(function(a){u++;a===e&&(A.push(C),x||C.isAllowed||(x=!0),u++);s={};s.index=u;s.isWrapper=c(this).is("[data-motopress-wrapper-id]");s.size=v[u];s.isWrapper?(s.wrapperWidth=E/100*CE.Grid.myThis.colWidthByNumber[v[u]],s.minSpan=t.resizer.getMinChildColumn(c(this)),s.minSize=t.getMinAllowedSpanSize(E,!0,s.minSpan),s.isAllowed=t.resizer.isAllowedColSize(s.minSpan,s.wrapperWidth)):(s.minSize=H,s.isAllowed=t.resizer.isAllowedColSize(v[u],
E));s.size<s.minSize?y+=s.minSize-s.size:z+=s.size-s.minSize;x||s.isAllowed||(x=!0);A.push(s)});e===G&&(A.push(C),x||C.isAllowed||(x=!0));if(x)if(y>z)r=!1;else{for(F=a=k=0;2*y!==k+a;){for(w=0;w<A.length;w++)A[w].isAllowed&&A[w].size>A[w].minSize&&k<y?(A[w].size--,k++):!A[w].isAllowed&&A[w].size<A[w].minSize&&(A[w].size++,a++);if(50<=++F){r=!1;break}}for(w=0;w<A.length;w++)b.push(A[w].size);q.to=b}}}}return p>=n||!r?(CE.DragDrop.interruptInsert=!0,h||(parent.MP.Flash.setFlash(localStorage.getItem("blocksOverflow"),
"error"),parent.MP.Flash.showMessage()),!1):Object.keys(q).length?q:!0},resize:function(a,b,d,e){e="object"===typeof e?e:{};var f=null;if(null!==a&&"undefined"!==typeof a){a=parent.MP.Utils.getEdgeRow(a).children(".motopress-clmn");var g=a.length;0<g&&g<=parent.CE.Iframe.myThis.gridObj.row.col&&(f=e.hasOwnProperty("from")?e.from:this.getSpanSizeRules(g),a.each(function(a){parent.MP.Utils.getSpanClass(c(this).prop("class").split(" "));CE.Resizer.myThis.changeSpanClass(c(this),parent.CE.Iframe.myThis.gridObj.span["class"]+
f[a])}))}if("undefined"===typeof d||"undefined"!==typeof d&&"insert"!==d)a=b.parent(),null!==a&&"undefined"!==typeof a&&(a=a.children(".motopress-clmn"),g=a.length,0<g&&g<=parent.CE.Iframe.myThis.gridObj.row.col&&(f=e.hasOwnProperty("to")?e.to:this.getSpanSizeRules(g),a.each(function(a){parent.MP.Utils.getSpanClass(c(this).prop("class").split(" "));CE.Resizer.myThis.changeSpanClass(c(this),parent.CE.Iframe.myThis.gridObj.span["class"]+f[a])})));"undefined"===typeof d||"top-in"!==d&&"bottom-in"!==
d||(parent.MP.Utils.getSpanClass(b.prop("class").split(" ")),CE.Resizer.myThis.changeSpanClass(b,parent.CE.Iframe.myThis.gridObj.span.fullclass),d="top-in"===d?1:0,b=b.closest(".motopress-row").parent(".motopress-clmn").children(".motopress-row").get(d),b=c(b),b=parent.MP.Utils.getEdgeRow(b).children(".motopress-clmn"),"undefined"!==typeof b&&b.length&&(parent.MP.Utils.getSpanClass(b.prop("class").split(" ")),CE.Resizer.myThis.changeSpanClass(b,parent.CE.Iframe.myThis.gridObj.span.fullclass)))},getSpanSizeRules:function(a){return this.spanSizeRules[a]},
generateSpanSizeRules:function(){for(var a=parent.CE.Iframe.myThis.gridObj.row.col,b=[],c=1;c<=a;c++){b[c]=[];for(var e=Math.floor(a/c),f=a%c,g=1;g<=c;g++)b[c].push(g<=f?e+1:e)}this.spanSizeRules=b},setCalcWrapperWidth:function(a){if(CE.Grid.myThis.padding){var b=2*CE.Grid.myThis.padding,c="";parent.MP.Utils.Browser.Mozilla?c="-moz-":parent.MP.Utils.Browser.Chrome&&(c="-webkit-");a.css("width",c+"calc(100% - "+b+"px)")}},sceneEvents:function(){this.container.off("hover").hover(function(){CE.Utils.addSceneAction("container-hover")},
function(){CE.Utils.removeSceneAction("container-hover")})},hideOuterHandles:function(){c(".motopress-outer-handle").addClass("motopress-outer-handle-hidden")},showOuterHandles:function(){c(".motopress-outer-handle").removeClass("motopress-outer-handle-hidden")}})}(jQuery),function(c){CE.Template=can.Control.extend({myThis:null,templates:null},{template:c("<div />",{"class":"motopress-template",html:'<img class="motopress-template-icon"><p class="motopress-template-name"></p>'}),init:function(a,b){CE.Template.myThis=
this;if(null!==CE.Template.templates){var d=this,e=[];c.each(CE.Template.templates,function(a,b){var c=d.template.clone();c.attr("data-motopress-template-id",b.id);c.children(".motopress-template-icon").attr("src",b.icon);c.children(".motopress-template-name").text(b.name);e.push(c)});this.element.append(e)}},".motopress-template click":function(a,b){var d=a.attr("data-motopress-template-id");d&&(parent.MP.Preloader.myThis.show(),c.ajax({url:parent.motopress.ajaxUrl,type:"POST",dataType:"html",data:{action:"motopress_ce_render_template",
nonce:parent.motopressCE.nonces.motopress_ce_render_template,postID:parent.motopressCE.postID,templateId:d},success:function(a){CE.Utils.removeSceneState("empty-scene");var b=c(a).find(".motopress-ce-private-styles-updates-wrapper").andSelf().filter(".motopress-ce-private-styles-updates-wrapper").children("style");CE.ShortcodePrivateStyle.addRenderedStyleTags(b);a=c(a).find(".motopress-ce-rendered-content-wrapper").andSelf().filter(".motopress-ce-rendered-content-wrapper").html();CE.DragDrop.myThis.emptySceneHelper.hide();
CE.DragDrop.myThis.emptySceneHelper.before(a);parent.CE.Iframe.myThis.unwrapGrid();CE.DragDrop.myThis.setEdges();CE.DragDrop.myThis.main();parent.CE.Save.changeContent();parent.MP.Preloader.myThis.hide()},error:function(a){parent.MP.Preloader.myThis.hide();a=c.parseJSON(a.responseText);a.debug?console.log(a.message):(parent.MP.Flash.setFlash(a.message,"error"),parent.MP.Flash.showMessage())}}))}})}(jQuery),function(c){CE.Selectable=can.Construct({myThis:null,scrollY:0,focusFlag:!1,blurFlag:!1,setScrollY:function(a){CE.Selectable.scrollY=
a},focusWithoutScroll:function(a){if(!CE.Selectable.focusFlag){CE.Selectable.focusFlag=!0;a.focus();window.scrollTo(0,CE.Selectable.scrollY);var b=setTimeout(function(){CE.Selectable.focusFlag=!1;clearTimeout(b)},0)}return a},blurWithoutScroll:function(a){if(!CE.Selectable.blurFlag){CE.Selectable.blurFlag=!0;a.blur();window.scrollTo(0,CE.Selectable.scrollY);var b=setTimeout(function(){CE.Selectable.blurFlag=!1;clearTimeout(b)},0)}return a}},{selectedClass:"motopress-selected",init:function(){CE.Selectable.myThis=
this;c(document).mousedown(function(){CE.Selectable.setScrollY(window.scrollY)});c(document).mouseup(function(){CE.Selectable.setScrollY(window.scrollY)});this.makeSelectable()},makeSelectable:function(){c(".motopress-content-wrapper").on("click",".motopress-drag-handle, .motopress-clmn-select-handle, .motopress-row-select-handle",function(){if(c(this).hasClass(".motopress-clmn-select-handle")&&c(this).closest(".motopress-clmn").hasClass(CE.Selectable.myThis.selectedClass)||c(this).hasClass(".motopress-row-select-handle")&&
c(this).closest(".motopress-row").hasClass(CE.Selectable.myThis.selectedClass)||c(this).hasClass(CE.Selectable.myThis.selectedClass)){var a=null,a=c(this).hasClass(".motopress-row-select-handle")?c(this).closest(".motopress-row"):c(this).hasClass(".motopress-clmn-select-handle")?c(this).closest(".motopress-clmn"):c(this).closest(".motopress-clmn").find(".motopress-block-content").first().children("[data-motopress-shortcode]"),b=a.control(),b=a.hasClass("ce_inline_editor")?b.isOpen:!1;!(a.hasClass("ce_controls")||
a.hasClass("ce_inline_editor")||a.hasClass("ce_code_editor")||a.hasClass(".motopress-row"))||CE.Dialog.myThis.element.dialog("isOpen")||parent.CE.CodeModal.myThis.element.data("modal").isShown||b||CE.Dialog.myThis.open(c(this))}else CE.Selectable.myThis.select(c(this));CE.Selectable.focusWithoutScroll(c(this).prev())});c(".motopress-content-wrapper").on("keydown",".motopress-focus-area",function(a){if(c(this).next().hasClass(CE.Selectable.myThis.selectedClass))if(a.which===c.ui.keyCode.ESCAPE)CE.Selectable.setScrollY(window.scrollY),
CE.Selectable.myThis.unselect();else if(a.which===c.ui.keyCode.DELETE||a.which===c.ui.keyCode.BACKSPACE)a.preventDefault(),CE.Selectable.setScrollY(window.scrollY),CE.Tools.myThis.removeBlock(),parent.CE.Save.changeContent()});c(document).on("click",function(a){c(a.target).hasClass(CE.Selectable.myThis.selectedClass)||c(a.target).hasClass("motopress-clmn-select-handle")||c(a.target).hasClass("motopress-row-select-handle")||c(a.target).closest("."+CE.Dialog.myThis.dialogClass).length||CE.InlineEditor.isTinymce(a)||
CE.Selectable.myThis.unselect()})},select:function(a){if(!1===CE.DragDrop.interruptInsert){this.unselect();var b=null;CE.Selectable.focusWithoutScroll(a.prev());a.hasClass("motopress-row-select-handle")?(a.closest(".motopress-row").addClass(this.selectedClass),b=a.closest(".motopress-row")):(a.hasClass("motopress-clmn-select-handle")?a.closest(".motopress-clmn").addClass(this.selectedClass):a.addClass(this.selectedClass).closest(".motopress-helper").nextAll('.ui-resizable-handle:not(".motopress-hide")').show(),
b=a.closest(".motopress-clmn"));CE.Utils.addSceneAction("select");a.hasClass("motopress-row-select-handle")||a.hasClass("motopress-clmn-select-handle")||parent.CE.Navbar.myThis.showObjectControlBtns();(b.hasClass("ce_controls")||b.hasClass("ce_inline_editor")||b.hasClass("ce_code_editor")||b.hasClass("motopress-row"))&&!CE.Dialog.myThis.element.dialog("isOpen")&&CE.Dialog.myThis.open(a)}CE.DragDrop.interruptInsert=!1},unselect:function(){var a=c(".motopress-content-wrapper ."+this.selectedClass);
a.length&&(a.each(function(){c(this).removeClass(CE.Selectable.myThis.selectedClass);c(this).hasClass("motopress-clmn")||c(this).hasClass("motopress-row")||c(this).closest(".motopress-helper").nextAll('.ui-resizable-handle:not(".motopress-hide")').hide()}),parent.CE.Navbar.myThis.hideObjectControlBtns(),CE.Dialog.myThis.element.dialog("isOpen")&&CE.Dialog.myThis.element.dialog("close"),CE.InlineEditor.curElement&&CE.InlineEditor.curElement.control().close(),CE.Selectable.blurWithoutScroll(a.prev()),
CE.Utils.removeSceneAction("select"))}})}(jQuery),function(c){c.hasOwnProperty("stellar")&&c.stellar("refresh");c.hasOwnProperty("fn")&&c.fn.hasOwnProperty("button")&&c.fn.button.hasOwnProperty("noConflict")&&(c.fn.btn=c.fn.button.noConflict());new CE.Utils;CE.WPMore.getInstance();new CE.StyleEditor;new CE.LeftBar;new CE.ImageLibrary;new CE.WPGallery;new CE.WPMedia;new CE.WPAudio;new CE.WPVideo;new CE.Dialog;new CE.Selectable;new CE.Link;parent.MP.Editor.myThis.load()}(jQuery)}catch(L){parent.MP.Error.log(L,
!0)}});
